...
public class DialerDataSubscription extends AmbientDataSubscription<CallMethodInfo> {
    ...
    protected void requestedModInfo(ArrayList<TypedPendingResult> queries,
        ...
        queries.add(InCallQueries.getCallMethodInfo(this, componentName));
        queries.add(InCallQueries.getCallMethodStatus(this, componentName));
        queries.add(InCallQueries.getCallMethodMimeType(this, componentName));
        queries.add(InCallQueries.getCallMethodVideoCallableMimeType(this, componentName));
        queries.add(InCallQueries.getCallMethodAuthenticated(this, componentName));
        queries.add(InCallQueries.getLoginIntent(this, componentName));
        queries.add(InCallQueries.getSettingsIntent(this, componentName));
        queries.add(InCallQueries.getCreditInfo(this, componentName));
        queries.add(InCallQueries.getHintText(this, componentName));
        queries.add(InCallQueries.getManageCreditsIntent(this, componentName));
