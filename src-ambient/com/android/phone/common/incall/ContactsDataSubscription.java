...
public class ContactsDataSubscription extends DialerDataSubscription {
    ...
    public void onDynamicRefreshRequested(ArrayList<TypedPendingResult> queries,
        ...
        queries.add(InCallQueries.getCallMethodAccountHandle(this, componentName));
    }
    ...
    protected void requestedModInfo(ArrayList<TypedPendingResult> queries,
        ...
        queries.add(InCallQueries.getDefaultDirectorySearchIntent(this, componentName));
        queries.add(InCallQueries.getCallMethodImMimeType(this, componentName));
