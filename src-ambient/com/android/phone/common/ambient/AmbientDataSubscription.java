...
public abstract class AmbientDataSubscription<M> {
    ...
    public interface PluginChanged<M> {
        void onChanged(HashMap<ComponentName, M> pluginInfos);
    }
    ...
    /**
     * Gets the required queries for all our plugin
     ...
     * plugin info is already collected and the initial broadcast has been sent.
     *
