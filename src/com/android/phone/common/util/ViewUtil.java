...
public class ViewUtil {
    ...
    public static void resizeText(TextView textView, int originalTextSize, int minTextSize) {
        ...
        // Setting text size using float may result in slightly bigger font due to rounding.
        // Therefore, reducing the text size value by 1 to ensure text always fits in the text view.
        final float textSizeRoundingError = 1.0f;
        ...
        if (ratio <= 1.0f) {
            textView.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                    Math.max(minTextSize, originalTextSize * ratio - textSizeRoundingError));
        }
    }
}
